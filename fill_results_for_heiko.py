...
from dashboard_ppwr import CHECK_ORDER, resolve_check

BASE_DIR = os.path.dirname(os.path.abspath(__file__))
AUDIT_CSV = os.path.join(BASE_DIR, "ppwr_audit_results.csv")
HEIKO_XLSX = os.path.join(BASE_DIR, "docs", "results_for_heiko.xlsx")
